...
class SprintSubprocessInstance:
    ...
    def _build_sprint_args(self):
        config_str = "c2p_fd:%i,p2c_fd:%i" % (self.pipe_c2p[1].fileno(), self.pipe_p2c[0].fileno())
...
class ReaderThread(Thread):
    ...
    def __init__(
        self, instance, instance_idx, batch_idxs, tags, seq_lengths, log_posteriors, batch_loss, batch_error_signal
    ):
        """
